...
<div class='w3-display-bottommiddle w3-light-grey w3-card-4 w3-center w3-hide-medium w3-hide-small' style='width: 290px;position: relative; top:20px;'>
    ...
    <h4 class='w3-hide-medium' style='font-family: $font_style, cursive;'>Alterar dados pessoais</h4>
     </div>   
...
<p><label class='w3-text-black  w3-mobile'><b>RG:</b></label></p>
        <p><input name='rg' value='$rg' class='w3-center w3-input w3-border w3-light-grey  w3-mobile' type='text' style='width: 260px;'>

        <p><label class='w3-text-black  w3-mobile'><b>Nome:</b></label>
       <p> <input name='nome' value='$nome' class='w3-center w3-input w3-border w3-light-grey  w3-mobile' type='text' style='width: 260px;'></p>

<p><label class='w3-text-black w3-mobile'><b>Data de nascimento:</b></label></p>
       <p> <input name='dtn' value='$dtn' class='w3-center w3-input w3-border w3-light-grey w3-mobile' type='text' style='width: 260px;'></p>


<p><label class='w3-text-black  w3-mobile'><b>Telefone:</b></label></p>
       <p> <input name='telefone' value='$telefone' class='w3-center w3-input w3-border w3-light-grey  w3-mobile' type='text' style='width: 260px;'></p>

        <p><label class='w3-text-black'><b>Endereço:</b></label></p>
      <p>  <input name='endereco' value='$endereco' name='endereco' class='w3-center w3-input w3-border w3-light-grey  w3-mobile' type='text' style='width: 260px;'></p>


<p> <label class='w3-text-black w3-mobile'><b>Nome da mae:</b></label></p>
        <p> <input name='nomemae' value='$nomeMae' class='w3-center w3-input w3-border w3-light-grey w3-mobile' type='text' style='width: 260px;'></p>

<p> <label class='w3-text-black w3-mobile'><b>Nome do pai:</b></label></p>
         <p><input name='nomepai' value='$nomePai' class='w3-center w3-input w3-border w3-light-grey w3-mobile' type='text' style='width: 260px;'></p>

       <p> <input type='submit' class='w3-input w3-button w3-blue w3-mobile' value='Enviar' style='width:160px;position:relative;right:-50px;font-family: $font_style, cursive;'></p>
...
<div class='w3-display-bottommiddle w3-light-grey w3-card-4 w3-center w3-hide-large w3-hide-small' style='width: 290px;position:relative;bottom:-64px;'>
    ...
    <h4 style='font-family: 'Alfa Slab One', cursive;'>Alterar dados pessoais</h4>
     </div>   
   
  <form class='w3-container w3-hide-large w3-mobile' method='POST' action='acoes/alterandoDados.php' enctype='multipart/form-data'>
...
<!-- FORMULARIO MEDIUM -->
    ...
    <h4 style='font-family: $font_style, cursive;'>Alterar dados pessoais</h4>
     </div>   
...
<p> <label class='w3-text-black w3-mobile'><b>Nome do pai:</b></label></p>
       ...
       <p> <input type='submit' class='w3-input w3-button w3-blue w3-mobile' value='Enviar' style='width:160px;position:relative;font-family: $font_style, cursive;'></p>

...
<html>
<head>    
<title>Histórico de trocas</title>
...
<p class="w3-responsive w3-center w3-large" style="font-family: 'Alfa Slab One', cursive;">HISTÓRICO DE TROCAS</p>
  ...
  <!-- CÓNTEÚDO DA PÁGINA - INÍCIO -->
   ...
   <?php
      ...
      require_once('./classes/HistoricoDeTroca.php');
